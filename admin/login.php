...
<head>       
    <title>Royal Aria Booking System - Login Page</title>
...
<div id="page-container" class="main-content-boxed">
    ...
    <main id="main-container">
        <!-- Page Content -->
        <div class="bg-image" style="background-image: url('assets/img/photos/conference-center-4.webp');">
            <div class="row mx-0 bg-black-op">
                <div class="hero-static col-md-6 col-xl-8 d-none d-md-flex align-items-md-end">
                    <div class="p-30 invisible" data-toggle="appear">
                        <p class="font-size-h3 font-w600 text-white">
                            Royal Aria Booking System.
                        </p>
                        <p class="font-italic text-white-op">
                            CSI 408 2024 PROJECT
                        </p>
                    </div>
                </div>
                    ...
                    <div class="content content-full">
                        ...
                        <div class="px-30 py-10">
                            <a class="link-effect font-w700" href="login.php">
                                ...
                                <span class="font-size-xl">Royal Aria</span>
                            </a>
